              ...
              {priceMap.map(price => (
                <Trow>
                  {headers.headerData.map((key, index) => {
                    return (
                      <Tcell key={index} col="2">
                        {price[key.propertyName]}
                      </Tcell>
                    );
                  })}
                </Trow>
            ...
            <Thead>
              <Trow>
                {Object.keys(headers.FxeHeaders).map((key, index) => {
                  return (
                    <Tcell key={index} col="3">
                      {headers.FxeHeaders[key]}
                    </Tcell>
                  );
                })}
              </Trow>
            ...
            <Thead>
              <Trow>
                {Object.keys(headers.FxgHeaders).map((key, index) => {
                  return (
                    <Tcell key={index} col="4">
                      {headers.FxgHeaders[key]}
                    </Tcell>
                  );
                })}
              </Trow>
            ...
            <Thead>
              <Trow>
                {Object.keys(headers.FxfHeaders).map((key, index) => {
                  return (
                    <Tcell key={index} col="5">
                      {headers.FxfHeaders[key]}
                    </Tcell>
                  );
                })}
              </Trow>
